...
const Auth = () => {
    ...
    const signIn = () => {
        ...
        .catch((error) => {
            ...
            if(errorCode === "auth/wrong-password"){
                alert("패스워드가 일치하지 않습니다."); return
            }else if(errorCode === "auth/invalid-email"){
                alert("유효하지 않은 이메일 주소입니다."); return
            }else{
    ...
    return(
        <div className="wrap">
            ...
            <div className="card">
                <div className="mt-0 font-semibold">Firebase Auth</div>
                <div className="text-sm text-red-500 mt-2">* 이메일 방식 테스트 계정 : test@gmail.com / qwe123!@#</div>
